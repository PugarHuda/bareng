// Prove ONE real on-chain Universal Account spend — the answer to gap #1 (nothing has run
// on-chain yet). Reuses the SAME lib the app uses (lib/universalAccount.ts), so a green run
// here means the live path is real too.
//
